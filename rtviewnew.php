        ...
        <div class="page-inner page-inner-tab-style">
          ...
          <div class="row">
            <div class="col-md-12">
              <?php 
                 include('config.php');
                 $sql = mysqli_query($con,"SELECT * FROM tb_rtpcrnewcifonline ") or die(mysqli_error($con));
              ...
              <div class="card">
                ...
                <div class="card-body">
                 <?php
                  ...
                  $sqlcodecheck = mysqli_query($con,"SELECT * FROM tb_rtpcrnewcifonline WHERE rt_primaryai !='0' ORDER BY rt_primaryai DESC LIMIT 50 ");
