                                    ...
                                    date_default_timezone_set('Asia/Manila');
                                        if(isset($_POST['submit'])) {
                                            ...
                                            $result = mysqli_query($con, "SET NAMES utf8") or die(mysqli_error($con));
                                                ...
                                                $search = mysqli_query($con,"SELECT rt_id, rt_lname, rt_fname, rt_mname, rt_suffix, rt_timestamp, rt_si1collected, rt_ctrtimestamp, rt_finalresult, rt_validation, rt_validation2 FROM `tb_rtpcrnewv9` WHERE rt_id='$rt_id'");
