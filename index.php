    ...
    <body>
        ...
        <div  style='background-image: url("images/banners/rtpcr.jpg");padding-top:2%;padding-bottom:2%;background-size: initial;background-repeat: no-repeat;background-position: 50% 15%;'  class="mg-page-title parallax">
            <div class="container-fluid" style='margin-top:6%;'>
                <div class="row">
                    <div class="col-md-12">
                        <h1>MIHMCI RT-PCR Appointment</h1>
...
if($purpose==''){
 ...
 if($sqlschedcheck>1000){
     ...
     if($countsqlcodecheck>=1){
      ...
      $duplicate  = mysqli_query($con, "SELECT * FROM tb_rtpcr WHERE rt_fname='$fname' AND rt_lname='$lname' AND rt_mname='$mname' AND rt_bday='$bdate' AND rt_datesched='$date'") or die(mysqli_error($con));
...
$sunday = date('l', $xdate);
        ...
        }else*/if(mysqli_num_rows($duplicate)>=1){
...
{
   echo "<div class='alert alert-primary' align='center'><strong>Success! </strong> An email has been sent to <b>$email</b> for verification.<br>E-mail may be delayed up to 1 minute.<br>See you at Metro Iloilo Hospital & Medical Center, Inc.<br><br>Login to your Applicant profile using credentials below:<br>
    Username: <b>".$lname."</b>
                            ...
                            <div class="col-md-6 col-lg-4 font-weight-bold">
                                <div>
                                    ...
                                    <div class="col-md-6 col-lg-4 font-weight-bold">
                                        <div>
                                            Middle Name:
                                            <input class="form-control" type="text" name="mname" placeholder="Middle Name" autocomplete="off" value='<?php echo $mname; ?>'>
                                        </div>
                                    </div>
                              ...
                              <div class="col-md-6 col-lg-4 font-weight-bold">
                                        <div>
                                            ...
                                            <!--<input class="form-control" type="date" required name="date" placeholder="yyyy-mm-dd" autocomplete="off" value='<?php echo $date; ?>' pattern="\d{4}-\d{2}-\d{2}"> -->
                                        </div>
                                    </div>
