    ...
    <body>
        ...
        <section class="mg-best-rooms"  style="background-color: #ffffff;">
            <div class="container-fluid" >
                <div class="row" >
                    <div class="col-lg-12 alert alert-success shadow-lg">
...
$msg=$img."<br>Dear ".$greet." ".$lname.", 
    ...
    <br><br>
    <h3><b>Please login to your account and print your CIF, or Notify the triage personnel upon your visit to print your CIF at Metro Iloilo Hospital & Medical Center, Inc.</b></h3>
    <br><br>
...
if (mail($to, $subject, $message, $headers)){
  ...
  /*}*/
                                ...
                                ?> 
                        <div class="row bg-light border border-secondary pb-2 shadow-lg">
                            <div class="col-lg-12 text-center font-weight-bold pt-1 pb-1 bg-secondary text-white mb-3"> 
                            ...
                            <div class="col-lg-2 font-weight-bold  ">
                              ...
                              <div class="col-lg-3 font-weight-bold">                              
                                   ...
                                   <!-- <div class="col-md-6 col-lg-6 font-weight-bold">
                                    ...
                                    <div class="col-lg-12 text-center font-weight-bold  bg-secondary text-white pt-1 pb-1"> 
                                    ...
                                    <div class="col-lg-3 font-weight-bold">
                                            Brgy:
                                            <input class="form-control" type="text"   name="curbarangay" id ="daddbrgy"  placeholder=" " value='<?php echo $curbarangay;; ?>' required>
                                    </div>
                                    <div class="col-lg-3 font-weight-bold">
                                            Municipality/City:
                                            <input class="form-control" type="text"   name="curcity"  id ="dcity"   placeholder=" " value='<?php echo $curcity; ?>' required>
                                    </div>
                                    <div class="col-lg-3 font-weight-bold">
                                            Province:
                                            <input class="form-control" type="text"   name="curprovince"    value='<?php echo $curprovince; ?>' required>
                                    </div>
                                    ...
                                    <div class="col-lg-3 font-weight-bold">
                                            Home Phone:
                                            <input class="form-control" type="text"   name="curhomephone"  placeholder=" " value='<?php echo $curhomephone; ?>' required>
                                    </div>
                                    <div class="col-lg-3 font-weight-bold">
                                            Cellphone #:
                                            <input class="form-control" type="text"   name="curcontactnumber" placeholder=" " value='<?php echo $curcontactnumber; ?>' required>
                                    </div>
                                    <div class="col-lg-3 font-weight-bold">
                                            E-mail (For Result):
