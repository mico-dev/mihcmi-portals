...
$query = "SELECT rt_id, rt_lname, rt_fname, rt_mname, rt_sendstatus, rt_suffix, rt_timestamp, rt_linestatus, rt_validation, rt_dateofinterview, rt_sentdate, rt_validationts FROM tb_rtpcrnewcif ";
