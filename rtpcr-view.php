...
$query = "SELECT rt_id, rt_lname, rt_fname, rt_mname, rt_sendstatus, rt_suffix, rt_timestamp, rt_linestatus, rt_validation, rt_dateofinterview, rt_sentdate, rt_validationts FROM tb_rtpcrnewv9";
...
if($a<=$b) {
	...
	$receivedquery = mysqli_query($con, "SELECT rt_id, rt_dateofinterview, rt_timestamp FROM `tb_rtpcrnewv9` WHERE rt_dateofinterview='$dateofinterview' ORDER BY rt_id DESC LIMIT 1")or die(mysqli_error($con));
