...
$sql = mysqli_query($con, "SELECT rt_id, rt_timestamp, rt_linestatus, rt_validation, rt_dateofinterview, rt_validationts, rt_sentdate, rt_lname, rt_fname, rt_mname, rt_suffix FROM tb_rtpcrnewcif WHERE rt_id='$id' UNION ALL SELECT rt_id, rt_timestamp, rt_linestatus, rt_validation, rt_dateofinterview, rt_validationts, rt_sentdate, rt_lname, rt_fname, rt_mname, rt_suffix FROM tb_rtpcrnewv9 WHERE rt_id='$id'") or die(mysqli_error($con));
